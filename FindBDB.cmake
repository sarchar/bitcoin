...
find_path(BDB_INCLUDE_DIR db.h HINTS "${BDB_ROOT}/build_windows")
find_library(BDB_RELEASE_LIBRARY libdb48  HINTS "${BDB_ROOT}/build_windows/Win32/Release")
find_library(BDB_DEBUG_LIBRARY libdb48d  HINTS "${BDB_ROOT}/build_windows/Win32/Debug")

set(BDB_LIBRARY optimized ${BDB_RELEASE_LIBRARY} debug ${BDB_DEBUG_LIBRARY} )
